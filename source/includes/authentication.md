...
```http
POST /api/0.7/messages/log HTTP/1.1
...
| `<api_endpoint_path>` | The complete path of the URL of the API method endpoint. Example: */api/0.7/message/send* |
