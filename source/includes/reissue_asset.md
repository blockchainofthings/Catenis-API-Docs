...
| ----------- | ------------- |
| 400 | <a href="#error_msg_3">Amount to issue is too large<br><a href="#error_msg_7">Asset cannot be reissued<br><a href="#error_msg_105">Invalid asset ID<br><a href="#error_msg_115">Invalid holding device<br><a href="#error_msg_130">Invalid parameters<br><a href="#error_msg_155">Not enough credits to pay for issue asset service |
