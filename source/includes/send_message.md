...
| ----------- | ------------- |
| 400 | <a href="#error_msg_130">Invalid parameters<br><a href="#error_msg_140">Invalid target device<br><a href="#error_msg_150">Message too long to be embedded<br><a href="#error_msg_170">Not enough credits to pay for send message service |
