...
```http--raw
GET /api/0.12/assets/aQjlzShmrnEZeeYBZihc/holders?limit=200 HTTP/1.1
...
```shell
curl "https://sandbox.catenis.io/api/0.12/assets/aQjlzShmrnEZeeYBZihc/holders?limit=200" \
