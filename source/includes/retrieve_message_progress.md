...
```http--raw
GET /api/0.12/messages/hfHtyPCS68toB9FjA8rM/progress HTTP/1.1
...
```shell
curl "https://sandbox.catenis.io/api/0.12/messages/hfHtyPCS68toB9FjA8rM/progress" \
...
| ----------- | ------------- |
| 400 | <a href="#error_msg_127">Invalid or expired ephemeral message</a><br><a href="#error_msg_207">Progress not available</a> |
