...
```http--raw
GET /api/0.10/permission/events/receive-msg/rights/dv3htgvK7hjnKx3617Re HTTP/1.1
...
```shell
curl "https://sandbox.catenis.io/api/0.10/permission/events/receive-msg/rights/dv3htgvK7hjnKx3617Re" \
