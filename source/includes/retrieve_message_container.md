...
```http--raw
GET /api/0.12/messages/oDWPuD5kjCsEiNEEWwrW/container HTTP/1.1
...
```shell
curl "https://sandbox.catenis.io/api/0.12/messages/oDWPuD5kjCsEiNEEWwrW/container" \
...
| ----------- | ------------- |
| 400 | <a href="#error_msg_120">Invalid message ID</a><br><a href="#error_msg_130">Invalid parameters: <i>&lt;param_list&gt;</i></a> |
