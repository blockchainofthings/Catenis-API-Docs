...
```shell
curl "https://sandbox.catenis.io/api/0.5/messages/mDWPuD5kjCsEiNEEWwrW?encoding=utf8" \
...
| ----------- | ------------- |
| 400 | <a href="#error_msg_120">Invalid message ID<br><a href="#error_msg_130">Invalid parameters |
